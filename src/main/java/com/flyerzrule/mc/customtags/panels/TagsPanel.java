...
public class TagsPanel {
    ...
    public TagsPanel(JavaPlugin plugin, Player player, List<Tag> allTags, List<Tag> ownedTags) {
        this.player = player;

        TagItemManager ownedItemManager = new TagItemManager(plugin);
        ...
        TagItemManager allItemManager = new TagItemManager(plugin);
        ...
        this.ownedGui = ScrollGui.items().setStructure(
                ...
                .addIngredient('a',
                        new SimpleItem(new ItemBuilder(Material.DIAMOND).setDisplayName("View All Available Tags"),
                                event -> openAll()))
        ...
        this.allGui = ScrollGui.items().setStructure(
                ...
                .addIngredient('u', new ScrollUpItem())
                .addIngredient('d', new ScrollDownItem())
                .addIngredient('o', new SimpleItem(new ItemBuilder(Material.EMERALD).setDisplayName("View Owned Tags"),
                        event -> openOwned()))
                .setContent(allItems)
                .build();
